...
const ADMIN_MODULE_SEARCH_ITEMS: AdminModuleSearchItem[] = [
  ...
  { href: getAdminSettingsHref("registration", "sms"), label: "短信配置", category: "站点设置子页", description: "配置内置阿里云短信发送器，用于手机注册、短信登录、手机绑定和手机找回密码。", keywords: ["短信", "手机短信", "阿里云短信", "aliyun sms", "accesskey", "短信签名", "模板code", "手机验证码"] },
